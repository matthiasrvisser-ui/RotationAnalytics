          ...
          <div className="max-w-3xl">
            ...
            <div className="border border-slate-200 rounded-lg bg-white overflow-hidden mb-6">
              <div className="h-96 overflow-y-auto p-6 text-sm text-slate-700 leading-relaxed space-y-4">
                ...
                <p>An Engagement begins only upon: (a) execution of this Agreement by electronic acceptance; and (b) receipt of complete submission materials. Fees are calculated automatically based on the published rate schedule at the time of submission. An invoice will be issued upon receipt of submission materials. Rotation Analytics will commence analysis immediately upon submission.</p>
