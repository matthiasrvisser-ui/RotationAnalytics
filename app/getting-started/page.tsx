...
export const metadata: Metadata = {
  ...
  description:
    'How to engage Rotation Analytics for independent rotation compliance and fatigue risk analysis. Sign the agreement, submit your rotation, receive findings.',
  openGraph: {
