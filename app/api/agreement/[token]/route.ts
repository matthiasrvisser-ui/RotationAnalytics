...
function parseAgreement(): { title: string; subtitle: string; preamble: string[]; sections: { heading: string; paragraphs: string[] }[]; closing: string[] } {
  ...
  sections.push({
    ...
    paragraphs: [
      ...
      '2.5 Engagement Models. Rotation Analytics Inc offers both ad hoc and integrated engagement models: (a) Ad Hoc Engagement: single-rotation analysis commissioned on an as-needed basis; (b) Integrated Engagement: recurring analytical support across rotation cycles, enabling trend identification, comparative risk assessment, and ongoing rotational risk monitoring. Rotation Analytics Inc recommends integrated engagement for organizations seeking sustained oversight of rotational risk. Ad hoc engagements may be converted to integrated engagements at any time upon written request.',
  ...
  sections.push({
    ...
    paragraphs: [
      ...
      '3.7 Turnaround Exclusions. The turnaround period is tolled during: (a) any period in which Rotation Analytics Inc is awaiting additional information or clarification from the Client; and (b) force majeure events beyond the reasonable control of Rotation Analytics Inc.',
    ],
  })
  ...
  sections.push({
    ...
    paragraphs: [
      '4.1 The Client shall: (a) provide accurate and complete materials; (b) provide all applicable Governing Documents; (c) identify applicable standards; (d) notify Rotation Analytics Inc of errors or changes; and (e) independently review Deliverables before reliance.',
  ...
  return {
    ...
    subtitle: 'Rotation Analytics Inc — a division of Visser Ventures Corp.\nAnalytical Services — Terms and Conditions',
    preamble,
    sections,
    closing,
  }
...
export async function GET(
  ...
  doc.setAuthor('Rotation Analytics Inc')
  doc.setSubject('Service Agreement')
  doc.setCreator('Rotation Analytics Inc')
  ...
  ctx.y -= 6
  drawText(ctx, 'Rotation Analytics Inc — a division of Visser Ventures Corp.', { font: fontItalic, size: 11, color: GRAY })
  ctx.y -= 2
  ...
  drawText(ctx, 'Operating as Rotation Analytics Inc', { font: fontItalic, size: 9.5, color: GRAY })
  ctx.y -= 10
