...
**3.1** Deliverables include:

(a) **Annotated Rotation Schedule**; and
...
(a) provide accurate and complete materials;

(b) provide all applicable Governing Documents;
...
(c) operational decisions or implementation by the Client; or

(d) third-party claims relating to the Client's rotation schedules, employment practices, or workplace operations.
...
*This Agreement is intended for commercial analytical services in Canada. Parties are encouraged to obtain independent legal advice prior to execution.*
