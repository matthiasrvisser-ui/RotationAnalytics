const steps = [
  {
    ...
    body: 'The rotation schedule is provided to Rotation Analytics by the Client. Confidential from point of receipt.',
  },
  {
    step: 'Step 2',
    ...
    <div>
      ...
      <div className="mt-6 pt-6 border-t border-slate-100">
        <p className="text-xs text-slate-400 leading-relaxed">
          All data and communication remains between Rotation Analytics and the Client.
        </p>
      </div>
    </div>
  )
